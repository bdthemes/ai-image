		...
		<div class="ai-image-tabs">
				...
				<ul class="ai-image-tabs__nav">
					<li class="ai-image-tabs__nav-item active openai" data-tab-target="openai">
						...
						<svg xmlns="http://www.w3.org/2000/svg" id="a" viewBox="0 0 100.1 100.1">
							<path
								d="m6.3,0h87.5c3.5,0,6.3,2.8,6.3,6.3v87.5c0,3.5-2.8,6.3-6.3,6.3H6.3c-3.5-.1-6.3-2.9-6.3-6.4V6.3C0,2.8,2.8,0,6.3,0Z"
					...
					<li class="ai-image-tabs__nav-item pexels" data-tab-target="pexels">
						...
						<svg xmlns="http://www.w3.org/2000/svg" id="a" viewBox="0 0 100.1 100.1">
							<path
								d="m6.3,0h87.5c3.5,0,6.3,2.8,6.3,6.3v87.5c0,3.5-2.8,6.3-6.3,6.3H6.3c-3.5-.1-6.3-2.9-6.3-6.4V6.3C0,2.8,2.8,0,6.3,0Z"
								style="fill:#05a081; stroke-width:0px;" />
							<path
								d="m39.32,67.16h13.31v-12.87h3.96c5.94-.11,10.67-4.95,10.56-10.89-.11-5.83-4.73-10.56-10.56-10.56h-17.27v34.32Zm20.13,6.93h-26.95V25.91h24.2c9.68,0,17.6,7.92,17.6,17.6,0,8.58-6.27,15.95-14.74,17.38v13.2h-.11Z"
								style="fill:#fff; stroke-width:0px;" />
						</svg>
					</li>
					<li class="ai-image-tabs__nav-item pixabay" data-tab-target="pixabay">
						...
						<svg xmlns="http://www.w3.org/2000/svg" id="a" viewBox="0 0 100.1 100.1">
							<path
								d="m6.3,0h87.5c3.5,0,6.3,2.8,6.3,6.3v87.5c0,3.5-2.8,6.3-6.3,6.3H6.3c-3.5-.1-6.3-2.9-6.3-6.4V6.3C0,2.8,2.8,0,6.3,0Z"
								style="fill:#48a947; stroke-width:0px;" />
							<path
								d="m51.38,42.69c-1.11-11.63-12.65-19.92-24.03-16.16-7.7,2.57-12.83,9.75-12.83,18.38v32.06c0,.6.09,1.2.17,1.97,2.39.17,4.87.17,7.27.09v-15.22h10.35c2.56,0,5.13-.34,7.61-1.37,7.69-3.25,12.23-11.03,11.46-19.75Zm-7.35,3.51c-.77,5.47-5.22,10.09-11.37,10-3.51-.09-6.93,0-10.69,0,0-4.62-.26-8.89.17-13.17.43-5.98,6.33-10.52,12.14-9.75,6.24.85,10.6,6.67,9.75,12.91Z"
								style="fill:#fafcfa; stroke-width:0px;" />
							<path
								d="m71.72,44.14l12.31-18.47h-8.89l-8.81,13.08-8.81-13.08h-8.98l12.31,18.47-13.77,19.41h8.89c3.51-4.53,6.58-9.41,10.35-14.02l10.26,14.02h8.98l-13.85-19.41Z"
								style="fill:#fafcfa; stroke-width:0px;" />
						</svg>
					</li>
			...
			<div class="ai-image-tabs__content">
				<div class="ai-image-tabs__content-item active" id="openai">
					...
					<div id="openai-loading-indicator" style="display: none;"><img style="background-color: #fff;"
							src="<?php echo esc_url( BDT_AI_IMAGE_ASSETS ); ?>imgs/icons8-loading-2.gif"></div>
				</div>
				<div class="ai-image-tabs__content-item" id="pexels">
					<div id="pexels-loaded-images" class="aiImg-loaded-images"></div>
					<div id="pexels-loading-indicator" style="display: none;"><img style="background-color: #fff;"
							src="<?php echo esc_url( BDT_AI_IMAGE_ASSETS ); ?>imgs/icons8-loading-2.gif"></div>
				</div>
				<div class="ai-image-tabs__content-item" id="pixabay">
					<div id="pixabay-loaded-images" class="aiImg-loaded-images"></div>
					<div id="pixabay-loading-indicator" style="display: none;"><img style="background-color: #fff;"
							src="<?php echo esc_url( BDT_AI_IMAGE_ASSETS ); ?>imgs/icons8-loading-2.gif"></div>
				</div>
				<div class="ai-image-tabs__content-item" id="tab3">
					<div id="unsplash-loaded-images" class="aiImg-loaded-images"></div>
					<div id="unsplash-loading-indicator" style="display: none;"><img style="background-color: #fff;"
							src="<?php echo esc_url( BDT_AI_IMAGE_ASSETS ); ?>imgs/icons8-loading-2.gif"></div>
				</div>
			</div>
		</div>
...
function upload_image_to_wp() {
	...
	if ( is_wp_error( $response ) ) {
		wp_send_json_error( 'Failed to fetch image.' );
	}
